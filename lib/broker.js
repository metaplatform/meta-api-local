...
var MemoryQueue = require(__dirname + "/memoryQueue.js");
 ...
 */
var Broker = function(queueManagerPrototype){
...
Broker.prototype.unsubscribeQueue = function(queue, connection){
	...
	Logger.debug("Connection #%s unsubscribed service {%s} from queue '%s'.", connection.clientId, connection.serviceName, channel);
